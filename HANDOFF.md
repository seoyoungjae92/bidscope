...
| 광고 | ✅ 2026-09-24 배너 연결 (문구 강조형). 광고그룹 `ait.v2.live.969bec1e38a54e7d` |
...
광고를 붙이려면 `VITE_AD_GROUP_ID=ait.v2.live.969bec1e38a54e7d` 를 넣는다
(비밀값 아님 — 콘솔 인앱 광고에서 다시 확인할 수 있다). 비워두면 배너를 그리지 않는다.
...
### ⑤ 사업자등록 — 광고 수익이 5,000원에 닿을 때 한다
출시에는 필요 없다. **IAP·토스 로그인·토스페이·프로모션·비즈월렛은 필수**,
**인앱 광고만 유예**된다 — 워크스페이스 누적 예상수익 **5,000원 미만까지는
사업자등록 없이** 광고 ID를 받아 수익화할 수 있고, 5,000원에 닿으면 **5영업일** 안에
등록해야 한다(미완료 시 미니앱 일시 미노출).
출처: [사업자 등록하기(공식 문서)](https://developers-apps-in-toss.toss.im/guide/operation/register-business),
[유예 가이드 2026-09-09](https://toss.im/apps-in-toss/blog/business-registration-deferral-guide)

> 2026-09-19에 이 유예를 "틀린 정보"로 적었다가 되돌렸다. 근거로 삼았던
> [2025-12-09 공지](https://techchat-apps-in-toss.toss.im/t/topic/1666)는 유예 도입(2026-08) 이전 것이다.
> **정책 확인은 공지 날짜부터 보라.**
> 다만 콘솔 약관 등록 화면에서 사업자번호를 요구하는 것을 실제로 만났다(2026-09-19).
> 문서와 화면이 다르니 광고를 붙일 때 채널톡으로 확인할 것.
